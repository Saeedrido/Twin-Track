...
const WorkerRegistration = () => {
  ...
  return (
    ...
    >
      <div className="registration-card shadow-lg p-4 bg-white rounded-4" style={{ width: "100%", maxWidth: "600px", margin: "0 auto" }}>
        <div className="text-center mb-4">
          ...
          />
          <h3 className="fw-bold fs-4">Worker Registration</h3>
